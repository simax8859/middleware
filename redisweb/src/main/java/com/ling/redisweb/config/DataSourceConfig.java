package com.ling.redisweb.config;
...
@Configuration
@MapperScan("com.ling.redisweb.mapper")
...
public class DataSourceConfig {
    ...
    public ServletRegistrationBean druidServlet() {
        ...
        reg.addInitParameter("allow", "192.168.56.101,127.0.0.1"); // IP白名单 (没有配置或者为空，则允许所有访问)
        reg.addInitParameter("deny", "192.168.56.102"); //IP黑名单 (存在共同时，deny优先于allow)
